...
class MessageDispatch:
    ...
    @classmethod
    def factory(cls, db_session: "DBSession", game_id: int) -> "MessageDispatch":
        return cls(
    ...
    def handle(self, message: Dict, session: "Session") -> "OutgoingMessages":
        ...
        return (
            self.HANDLERS[kind]
            .factory(db_session=self.db_session, game_id=self.game_id)
            .handle(message=message, session=session)
        )
